 ...
 */
public class ViewEntityNameDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.guidewire.datamodel.ViewEntityNameDocument
{
    private static final long serialVersionUID = 1L;
    
    public ViewEntityNameDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName VIEWENTITYNAME$0 = 
     ...
     */
    public com.guidewire.datamodel.ViewEntityNameDocument.ViewEntityName getViewEntityName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.guidewire.datamodel.ViewEntityNameDocument.ViewEntityName target = null;
            target = (com.guidewire.datamodel.ViewEntityNameDocument.ViewEntityName)get_store().find_element_user(VIEWENTITYNAME$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setViewEntityName(com.guidewire.datamodel.ViewEntityNameDocument.ViewEntityName viewEntityName)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.guidewire.datamodel.ViewEntityNameDocument.ViewEntityName)get_store().add_element_user(VIEWENTITYNAME$0);
            }
     ...
     * This is a complex type.
     */
    public static class ViewEntityNameImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.guidewire.datamodel.ViewEntityNameDocument.ViewEntityName
    {
        private static final long serialVersionUID = 1L;
        
        public ViewEntityNameImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
