 ...
 */
public class ViewEntityLinkDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.guidewire.datamodel.ViewEntityLinkDocument
{
    private static final long serialVersionUID = 1L;
    
    public ViewEntityLinkDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName VIEWENTITYLINK$0 = 
     ...
     */
    public com.guidewire.datamodel.ViewEntityLinkDocument.ViewEntityLink getViewEntityLink()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.guidewire.datamodel.ViewEntityLinkDocument.ViewEntityLink target = null;
            target = (com.guidewire.datamodel.ViewEntityLinkDocument.ViewEntityLink)get_store().find_element_user(VIEWENTITYLINK$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setViewEntityLink(com.guidewire.datamodel.ViewEntityLinkDocument.ViewEntityLink viewEntityLink)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.guidewire.datamodel.ViewEntityLinkDocument.ViewEntityLink)get_store().add_element_user(VIEWENTITYLINK$0);
            }
     ...
     * This is a complex type.
     */
    public static class ViewEntityLinkImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.guidewire.datamodel.ViewEntityLinkDocument.ViewEntityLink
    {
        private static final long serialVersionUID = 1L;
        
        public ViewEntityLinkImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
