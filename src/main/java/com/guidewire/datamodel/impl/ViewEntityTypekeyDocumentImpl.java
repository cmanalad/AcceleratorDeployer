 ...
 */
public class ViewEntityTypekeyDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.guidewire.datamodel.ViewEntityTypekeyDocument
{
    private static final long serialVersionUID = 1L;
    
    public ViewEntityTypekeyDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName VIEWENTITYTYPEKEY$0 = 
     ...
     */
    public com.guidewire.datamodel.ViewEntityTypekeyDocument.ViewEntityTypekey getViewEntityTypekey()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.guidewire.datamodel.ViewEntityTypekeyDocument.ViewEntityTypekey target = null;
            target = (com.guidewire.datamodel.ViewEntityTypekeyDocument.ViewEntityTypekey)get_store().find_element_user(VIEWENTITYTYPEKEY$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setViewEntityTypekey(com.guidewire.datamodel.ViewEntityTypekeyDocument.ViewEntityTypekey viewEntityTypekey)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.guidewire.datamodel.ViewEntityTypekeyDocument.ViewEntityTypekey)get_store().add_element_user(VIEWENTITYTYPEKEY$0);
            }
     ...
     * This is a complex type.
     */
    public static class ViewEntityTypekeyImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.guidewire.datamodel.ViewEntityTypekeyDocument.ViewEntityTypekey
    {
        private static final long serialVersionUID = 1L;
        
        public ViewEntityTypekeyImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
