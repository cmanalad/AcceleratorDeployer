 ...
 */
public class ComputedtypekeyDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.guidewire.datamodel.ComputedtypekeyDocument
{
    private static final long serialVersionUID = 1L;
    
    public ComputedtypekeyDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName COMPUTEDTYPEKEY$0 = 
     ...
     */
    public com.guidewire.datamodel.ComputedtypekeyDocument.Computedtypekey getComputedtypekey()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.guidewire.datamodel.ComputedtypekeyDocument.Computedtypekey target = null;
            target = (com.guidewire.datamodel.ComputedtypekeyDocument.Computedtypekey)get_store().find_element_user(COMPUTEDTYPEKEY$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setComputedtypekey(com.guidewire.datamodel.ComputedtypekeyDocument.Computedtypekey computedtypekey)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.guidewire.datamodel.ComputedtypekeyDocument.Computedtypekey)get_store().add_element_user(COMPUTEDTYPEKEY$0);
            }
     ...
     * This is a complex type.
     */
    public static class ComputedtypekeyImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.guidewire.datamodel.ComputedtypekeyDocument.Computedtypekey
    {
        private static final long serialVersionUID = 1L;
        
        public ComputedtypekeyImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        private static final javax.xml.namespace.QName PATHS$16 = 
            new javax.xml.namespace.QName("", "paths");
        private static final javax.xml.namespace.QName PRIMARYPATH$18 = 
            new javax.xml.namespace.QName("", "primaryPath");
        private static final javax.xml.namespace.QName SETTERSCRIPTABILITY$20 = 
        ...
        public org.apache.xmlbeans.XmlNMTOKEN xgetName()
        {
            synchronized (monitor())
            {
                ...
                target = (org.apache.xmlbeans.XmlNMTOKEN)get_store().find_attribute_user(NAME$14);
                return target;
            }
        }
        ...
        public void xsetName(org.apache.xmlbeans.XmlNMTOKEN name)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.XmlNMTOKEN)get_store().add_attribute_user(NAME$14);
                }
                target.set(name);
            }
        }
        ...
        public java.lang.String getPaths()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(PATHS$16);
                if (target == null)
                {
                    return null;
                }
        ...
        public org.apache.xmlbeans.XmlString xgetPaths()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.XmlString target = null;
                target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(PATHS$16);
                return target;
            }
        }
        ...
        public void setPaths(java.lang.String paths)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(PATHS$16);
                }
        ...
        public void xsetPaths(org.apache.xmlbeans.XmlString paths)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(PATHS$16);
                }
                target.set(paths);
            }
        }
        ...
        public java.lang.String getPrimaryPath()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(PRIMARYPATH$18);
                if (target == null)
                {
                    return null;
                }
        ...
        public org.apache.xmlbeans.XmlString xgetPrimaryPath()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.XmlString target = null;
                target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(PRIMARYPATH$18);
                return target;
            }
        }
        ...
        public boolean isSetPrimaryPath()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(PRIMARYPATH$18) != null;
            }
        }
        ...
        public void setPrimaryPath(java.lang.String primaryPath)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(PRIMARYPATH$18);
                }
        ...
        public void xsetPrimaryPath(org.apache.xmlbeans.XmlString primaryPath)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(PRIMARYPATH$18);
                }
        ...
        public void unsetPrimaryPath()
        {
            ...
            {
                check_orphaned();
                get_store().remove_attribute(PRIMARYPATH$18);
            }
        }
        ...
        public com.guidewire.datamodel.ScriptabilityType.Enum getSetterScriptability()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(SETTERSCRIPTABILITY$20);
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(SETTERSCRIPTABILITY$20);
                }
                if (target == null)
                {
                    return null;
        ...
        public com.guidewire.datamodel.ScriptabilityType xgetSetterScriptability()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.guidewire.datamodel.ScriptabilityType target = null;
                target = (com.guidewire.datamodel.ScriptabilityType)get_store().find_attribute_user(SETTERSCRIPTABILITY$20);
                if (target == null)
                {
                    target = (com.guidewire.datamodel.ScriptabilityType)get_default_attribute_value(SETTERSCRIPTABILITY$20);
                }
                return target;
            }
        }
        ...
        public boolean isSetSetterScriptability()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(SETTERSCRIPTABILITY$20) != null;
            }
        }
        ...
        public void setSetterScriptability(com.guidewire.datamodel.ScriptabilityType.Enum setterScriptability)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(SETTERSCRIPTABILITY$20);
                }
        ...
        public void xsetSetterScriptability(com.guidewire.datamodel.ScriptabilityType setterScriptability)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (com.guidewire.datamodel.ScriptabilityType)get_store().add_attribute_user(SETTERSCRIPTABILITY$20);
                }
        ...
        public void unsetSetterScriptability()
        {
            ...
            {
                check_orphaned();
                get_store().remove_attribute(SETTERSCRIPTABILITY$20);
            }
        }
    }
}
